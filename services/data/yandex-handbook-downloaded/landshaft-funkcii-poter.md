...
**Теорема 1** ([On the local minima free condition of backpropagation learning](https://ieeexplore.ieee.org/document/410380)) Если аналитична, ограничена и не тождественно равна нулю, ширина скрытого слоя не меньше и все столбцы матрицы различны, то все локальные минимумы глобальны.
...
1. аналитична, ограничена, не тождественно равна нулю;
2. производная нигде не обращается в ноль;
3. ;
4. ;
5. .
...
1. , строго монотонна и не найдётся ненулевых с , таких что ;
2. выпукла по второму аргументу и для любого ;
3. Существует , для которого и для всех .

Тогда если , то

1. Для каждого найдутся веса , для которых ;
2. Множество подуровня связно для каждого .