...
источник картинки — курс [UC Berkeley AI](http://ai.berkeley.edu/lecture_slides.html)
...
источник картинки — статья DeepMind [Producing Flexible Behaviours in Simulated Environments](https://deepmind.com/blog/article/producing-flexible-behaviours-simulated-environments)
...
1. Проинициализировать произвольным образом.
2. Пронаблюдать из среды.
3. Для :
...
1. Проинициализировать нейросеть .
2. Проинициализировать таргет-сеть, положив .
3. Пронаблюдать из среды.
4. Для :
