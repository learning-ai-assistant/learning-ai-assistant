...
1. **по распределению**, , если ;
2. **по вероятности**, , если для любого ;
3. **почти наверное**, , если ;
4. **в среднем квадратичном**, , если .
...
Простейший пример несмещённой оценки среднего значения даёт выборочное среднее , поскольку
...
Если , то . В секции про [бета-распределение](https://education.yandex.ru/handbook/ml/article/veroyatnostnye-raspredeleniya#nepreryvnye-raspredeleniya) была найдена плотность -й порядковой статистики, посчитанной по выборке из равномерного распределения на :
