...
**Вопрос на подумать**. Как инициализировать веса мы, наверное, понимаем (про это можно почитать в [параграфе](https://academy.yandex.ru/handbook/ml/article/tonkosti-obucheniya) про тонкости обучения нейросетей). А как инициализировать начальное скрытое состояние ? Можно ли инициализировать его нулём?
...
LSTM: вентиль забывания.[Источник](https://colah.github.io/posts/2015-08-Understanding-LSTMs)
...
LSTM: вентиль входного состояния. [Источник](https://colah.github.io/posts/2015-08-Understanding-LSTMs)
...
LSTM: обновление состояния блока. [Источник](https://colah.github.io/posts/2015-08-Understanding-LSTMs)
...
Теперь пропускаем cell state через гиперболический тангенс, чтобы значения были в диапазоне от до , и умножаем полученный вектор на o\_n, чтобы отфильтровать информацию из cell state, которую нужно подать на выход:

![](https://yastatic.net/s3/education-portal/media/img9_dda717d896_3c3f8599f2.webp)

LSTM: вентиль выходного состояния. [Источник](https://colah.github.io/posts/2015-08-Understanding-LSTMs)
...
GRU. [Источник](https://colah.github.io/posts/2015-08-Understanding-LSTMs)
...
1. Базовый dot-product, рассмотренный ранее:
2. Мультипликативный: , где — обучаемая матрица весов.
3. MLP: , где , — обучаемые матрицы весов, — обучаемый вектор весов
...
Вычисление self-attention для одного токена. [Источник](http://jalammar.github.io/illustrated-transformer/)
...
Схема вычисления multi-head self-attention. [Источник](http://jalammar.github.io/illustrated-transformer/)
...
8. [MixUp](https://arxiv.org/abs/1905.08941) для текстов. В задаче классификации смешиваем признаковые описания двух объектов и с такими же весами смешиваем их метки классов, получаем новый объект с признаками и меткой класса :
