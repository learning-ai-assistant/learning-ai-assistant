...
**Неравенство Маркова**. Пусть – неотрицательная случайная величина. Тогда для любого имеем
...
В общем случае, мы не можем предполагать наличие плотности у . Доказательство в этом случае можно найти в оригинальной работе D. A. McAllester [Some pac-bayesian theorems](https://link.springer.com/content/pdf/10.1023%2FA%3A1007618624809.pdf), а также в [конспекте лекций](https://arxiv.org/pdf/2012.05760.pdf) автора этого параграфа.
