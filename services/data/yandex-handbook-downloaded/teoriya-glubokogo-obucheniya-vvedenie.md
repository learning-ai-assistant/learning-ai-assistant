...
Схематическое изображение изменения эмпирического риска $\hat R\_m$ (синяя кривая) и предсказанного риска $\tilde R$ (красная кривая) в зависимости от ширины сети.
...
1. Каким-то образом делит её на две части: ,
2. Заменяет в метки на случайные.
3. Обучает модель на объединении и «испорченной» .
