...
![](https://yastatic.net/s3/education-portal/media/Artboard_30_f40ffa108f_4980246392.svg)

[Источник](https://arxiv.org/abs/2006.05525)
...
![](https://yastatic.net/s3/education-portal/media/Artboard_36_98f8d5dccd_5060fc72dc.svg)

[Источник](https://arxiv.org/abs/1612.03928)
...
![](https://yastatic.net/s3/education-portal/media/dml_ebbd86d63c_123acde9f5.webp)

[Источник](https://arxiv.org/abs/1706.00384)
...
Хороший пример метода из данной группы можно найти в [этой статье](https://arxiv.org/abs/1905.08094), где авторы пытаются заставить представления менее глубоких слоёв быть эквивалентными представлениям более глубоких слоёв. А именно, авторы предлагают разделить сеть на несколько частей ( в статье) и после каждой такой части добавить небольшую предсказательную голову. Все такие головы обучаются путем минимизации суммы трёх слагаемых:
...
![](https://yastatic.net/s3/education-portal/media/byot_85061c03aa_4a95b5f9f5.webp)

[Источник](https://arxiv.org/abs/1905.08094)
...
Тем удивительнее, что авторы статьи 2018 года [обнаружили](https://arxiv.org/abs/1805.04770), что самодистилляция в предложенной выше постановке позволяет получить прирост в обобщающей способности итоговой модели. Так, они проводят ряд экспериментов с моделями [DenseNet](https://arxiv.org/abs/1608.06993) и [Wide-ResNet](http://www.bmva.org/bmvc/2016/papers/paper087/index.html) на датасете CIFAR-100 и показывают, например, что самодистилляция DenseNet-112-33 позволяет повысить точность предсказания на тестовой выборке с до .
...
Авторы утверждают, что ученик обучается лучше переносить свои знания на новые данные. Предложенный метод позволил авторам добиться от модели [EfficientNet-L2](https://arxiv.org/abs/1905.11946) точности предсказания в на тестовом наборе данных ImageNet, существенно улучшив результат исходной модели в и обновив мировой рекорд.
...
В частности данный метод может быть использован для сжатия генеративных состязательных сетей. Так авторы довольно популярной статьи в данной области [демонстрируют](https://arxiv.org/abs/2003.08936) -, - и даже -кратное ускорение для ряда популярных pix2pix генеративных сетей, при этом не теряя в качестве генерации.
...
![](https://yastatic.net/s3/education-portal/media/Artboard_31_3b7e513b94_b630bc04df.svg)

[Источник](https://arxiv.org/abs/2006.07733)
